...
export const StripeTriggerDialog =({open,onOpenChange}:Props) =>{
    ...
    return(
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle className="text-primary">Stripe Trigger Configuration</DialogTitle>
                    <DialogDescription className="text-sm text-black pt-1">
                        Use this webhook URL in your Stripe account to trigger this workflow when a Stripe event occurs.
                    </DialogDescription>
                </DialogHeader>
