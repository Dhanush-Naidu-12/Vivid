    ...
    return (
        <Sidebar collapsible='icon'>
                ...
                <SidebarMenuItem>
                    <SidebarMenuButton asChild className='gap-x-4 h-10 px-4'>
                        <Link href='/' prefetch>
                           ...
                           <span className='text-sm font-semibold'>Vivid</span>
                        </Link>
                    </SidebarMenuButton>
                </SidebarMenuItem>
            </SidebarHeader>
            ...
            <SidebarFooter>
                ...
                <SidebarMenuItem>
                    <SidebarMenuButton tooltip='Logout' onClick={()=>authClient.signOut({fetchOptions:{onSuccess:()=>router.push('/login')}})} className='gap-x-4 h-10 px-4'>
