...
export const EnityContainer =({children,header,search,pagination}:EntityContainerProps) =>{
    return(
...
interface EntityListProps<T>{
    ...
    emptyViem?: React.ReactNode;
    className?: string;
}

export function EntityList<T> ({items, renderItem, getKey, emptyViem, className}:EntityListProps<T>) {
    if(items.length === 0 && emptyViem){
        return(
